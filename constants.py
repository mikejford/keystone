...
PERIODIC_EFFECT_AFFIX_LEVEL = 5
ENEMY_EFFECT_AFFIX_LEVEL = 10

GITHUB_URL = 'https://github.com/mikejford/keystone'
GITHUB_ICON_URL = 'https://image.flaticon.com/icons/svg/25/25231.svg'
RAIDER_IO_AFFIX_URL = 'https://raider.io/api/v1/mythic-plus/affixes?region=us&locale=en'
RAIDER_IO_STATIC_DATA_URL = 'https://raider.io/api/v1/mythic-plus/static-data?expansion_id=9'
RAIDER_IO_SEASON_SLUG = "season-df-4"
